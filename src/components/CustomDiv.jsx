...
const CustomDiv = ({ id, img, date, people, desc, amount, place }) => {
  ...
  return (
    <div className='flex flex-col p-6 rounded-xl gap-4 shadow-xl cursor-pointer w-[90%] poppins-medium max-md:w-full'>
      <div className='w-fit rounded-tr-xl rounded-tl-xl'>
        <img src={img} alt="" />
